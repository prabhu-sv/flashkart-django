...
SECRET_KEY = 'django-insecure-d(otmyto0j!1^265u3nrfl6niz%ure^%s=cn)y*vupt!d_w3gc'
...
MIDDLEWARE = [
    ...
    # 'whitenoise.middleware.WhiteNoiseMiddleware',  # Comment this out for local development
